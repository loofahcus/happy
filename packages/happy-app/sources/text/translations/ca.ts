...
export const ca: TranslationStructure = {
    ...
    newSession: {
        ...
        noResumableSession: 'Cap sessió anterior disponible',
    },
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Nom de la sessió',
        renameSessionSubtitle: 'Establir un nom personalitzat per a aquesta sessió',
