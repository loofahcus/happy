...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        noResumableSession: 'Nenhuma sessão anterior disponível',
    },
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Nome da sessão',
        renameSessionSubtitle: 'Definir um nome personalizado para esta sessão',
