...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Nazwa sesji',
        renameSessionSubtitle: 'Ustaw niestandardową nazwę dla tej sesji',
    ...
    files: {
        ...
        trackGitChanges: 'Śledzenie zmian Git',
        trackGitChangesDescription: 'Monitoruj zmiany plików w tle za pomocą git',
    },
