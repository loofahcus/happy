...
export const es: TranslationStructure = {
    ...
    newSession: {
        ...
        noResumableSession: 'No hay sesión anterior disponible',
    },
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Nombre de la sesión',
        renameSessionSubtitle: 'Establecer un nombre personalizado para esta sesión',
    ...
    files: {
        ...
        trackGitChanges: 'Seguimiento de cambios Git',
