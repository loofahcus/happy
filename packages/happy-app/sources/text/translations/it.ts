...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Nome della sessione',
        renameSessionSubtitle: 'Imposta un nome personalizzato per questa sessione',
    ...
    files: {
        ...
        deleted: 'Eliminato',
        trackGitChanges: 'Traccia Modifiche Git',
        trackGitChangesDescription: 'Monitora le modifiche ai file in background usando git',
    },
